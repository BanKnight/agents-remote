...
- [frontend-ui-architecture.md](./frontend-ui-architecture.md) — 定义 UI/UX prototype alignment 的来源优先级、三层页面模型、Home Project entry、URL-visible workspace 状态、移动端返回规则和共享 UI 边界。
