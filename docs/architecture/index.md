...
- [file-browser-preview.md](./file-browser-preview.md) — 定义 Project Files API、safe path 复用、只读 preview union 和文件系统读取边界。
- [git-diff-viewer.md](./git-diff-viewer.md) — 定义 Project Git diff API、Project-safe resolver 复用、只读 Git CLI 命令和 Git DTO 边界。
