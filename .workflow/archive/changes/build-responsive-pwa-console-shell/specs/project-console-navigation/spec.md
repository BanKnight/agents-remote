...
本文件记录 `build-responsive-pwa-console-shell` 对 `project-console-navigation` 的行为契约增量。

## Change 来源

- change-id：build-responsive-pwa-console-shell
- 来源意图：编号 1、31、42、43、74、75、76、77、82
- 规划来源：v0.2-project-console-shell 中的 Project 控制台外壳和 Agent/Terminal/Git/Files 信息架构；真实 Agent Runtime 接入后续 change 再定。
