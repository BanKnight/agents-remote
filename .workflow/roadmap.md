...
- 当前 change：align-instance-detail-workspaces
...
- 推进 `.workflow/changes/align-instance-detail-workspaces/`，读取其 `progress.md` 判断当前阶段，并使用 `step-change` 路由到对应阶段技能；其前置 `align-ui-shell-foundation` 与 `align-project-agent-workspace` 已完成。
