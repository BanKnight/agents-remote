...
- 当前 change：verify-prototype-ui-alignment
...
- 推进 `.workflow/changes/verify-prototype-ui-alignment/`，读取其 `progress.md` 判断当前阶段，并使用 `step-change` 路由到对应阶段技能；其依赖的 Home、Agent workspace、instance detail 和 resource pages changes 已完成。
