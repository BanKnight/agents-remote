...
- 当前 change：align-ui-shell-foundation
...
- 推进 `.workflow/changes/align-ui-shell-foundation/`，读取其 `progress.md` 判断当前阶段，并使用 `step-change` 路由到对应阶段技能；该 change 的前置 `design-frontend-ui-architecture` 已完成。
