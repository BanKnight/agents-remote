...
- 当前 version：v0.2-project-console-shell
- 当前 change：implement-project-model-and-safe-paths
- change 路径：.workflow/changes/implement-project-model-and-safe-paths/
...
- 继续推进 `.workflow/changes/implement-project-model-and-safe-paths/`；具体阶段见 `.workflow/changes/implement-project-model-and-safe-paths/progress.md`，技能路由由 `step-change` 决定。
