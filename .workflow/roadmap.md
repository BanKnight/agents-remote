...
- 当前 change：align-home-project-entry
...
- 推进 `.workflow/changes/align-home-project-entry/`，读取其 `progress.md` 判断当前阶段，并使用 `step-change` 路由到对应阶段技能；该 change 的前置 `align-ui-shell-foundation` 已完成。
