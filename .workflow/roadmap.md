...
- 当前 change：rework-session-mobile-console
...
- 推进 `rework-session-mobile-console`：在 Project 工作区入口完成后，重做 Terminal/Agent Session 详情页的移动端控制台布局、输入区、快捷键、返回、重连恢复和选择输入体验。
