...
export const MARKDOWN_CLASS =
  ...
  "[&_li]:mb-1 " +
  "[&_code]:rounded [&_code]:bg-surface-inset/60 [&_code]:px-1 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-xs " +
  "[&_pre_code]:bg-transparent [&_pre_code]:px-0 [&_pre_code]:py-0 " +
  "[&_a]:text-primary [&_a]:underline " +
  "[&_blockquote]:border-l-2 [&_blockquote]:border-neutral-line [&_blockquote]:pl-3 [&_blockquote]:text-on-surface-muted " +
  "[&_hr]:my-3 [&_hr]:border-neutral-line";
