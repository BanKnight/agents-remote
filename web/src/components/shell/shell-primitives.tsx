...
export const shellSurfaceClasses = {
  ...
  runtimeHeader: "border-b border-slate-700/80 bg-[#0a0e16]/80",
  runtimeBody: "bg-[#05080d]/50",
  runtimeComposer: "border-t border-slate-700/80 bg-[#0a0e16]/95",
  terminalTitlebar: "border-b border-slate-700/45 bg-[#141b28]/75",
