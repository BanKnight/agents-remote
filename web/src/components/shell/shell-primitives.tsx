...
export const shellSurfaceClasses = {
  shell: "bg-[#0f1520]/[0.45]",
  sidebar: "bg-gradient-to-b from-[#141b28]/[0.50] to-[#0a0e16]/[0.55]",
  workspace: "border border-white/10 bg-[#141b28]/35",
  header: "border border-white/10 bg-slate-950/40",
  floatingHeader: "sm:border sm:border-white/10 sm:bg-slate-950/40",
  bottomNav: "border-t border-slate-700/80 bg-[#0a0e16]/65",
  runtimeHeader: "border-b border-slate-700/80 bg-[#0a0e16]/50",
  runtimeBody: "bg-[#05080d]/30",
  runtimeComposer: "border-t border-slate-700/80 bg-[#0a0e16]/70",
  terminalTitlebar: "border-b border-slate-700/45 bg-[#141b28]/50",
  raised: "border border-slate-700/40 bg-[#141b28]/50",
  raisedHover: "hover:border-cyan-300/60 hover:bg-[#141b28]/70",
  dashed: "border border-dashed border-slate-700/70 bg-[#141b28]/45",
  inset: "border border-slate-700/35 bg-[#05080d]/15",
