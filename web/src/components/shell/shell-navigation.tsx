...
export function ShellMobileBottomNavigation({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto grid w-fit max-w-full gap-4 group-has-[.mobile-fab]:w-full group-has-[.mobile-fab]:max-w-[calc(100vw-9.5rem)] group-has-[.mobile-fab]:gap-1 rounded-2xl border border-on-surface/10 bg-surface-raised/40 px-2 py-2 shadow-2xl shadow-black/40 backdrop-blur-xl backdrop-saturate-150 ${colsClass}`}
      >
        {children}
      </div>
    </nav>
