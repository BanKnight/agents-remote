...
export const zh: Record<TranslationKey, string> = {
  ...
  "home.modeCreate": "新建目录",
  "home.modeAdopt": "采用已有目录",
  "home.adoptLoading": "正在扫描 PROJECTS_ROOT…",
  "home.adoptEmpty": "没有可采用的目录（均已纳管）",
  "home.adopting": "正在采用…",
  "home.adoptAction": "采用 {{count}} 个目录",
  "home.searchPlaceholder": "搜索项目与会话",
  "home.globalActivity": "全局活动",
  "home.nRunning": "{{count}} 进行中",
  "home.seeAllActivity": "查看全部活动",
  "home.collapseActivity": "收起活动",
  "home.projectsTitle": "项目 · {{count}}",
  "home.instanceRecent": "{{count}} 实例 · 最近：{{name}}（{{time}}）",
  "home.idle": "空闲",
  "home.noActivity": "暂无进行中的活动",
  ...
  "session.autoRetry.maxLabel": "窗口内最多（次）",
  "session.autoRetry.windowLabel": "窗口（分钟）",
  ...
  "files.searchEmpty": "无匹配文件",
  "files.deleteDirtyWarn": "该文件在 Git 工作区有未提交改动。",
  "files.capBreadcrumb": "点「..」或面包屑返回上级 · 点文件预览 · 长按文件操作",
  "files.uploadQueue.uploading": "正在上传 {{count}} 个文件",
  "files.uploadQueue.queued": "待上传 {{count}} 个文件",
  "files.uploadQueue.conflict": "同名冲突：",
  "files.uploadQueue.overwrite": "覆盖",
  "files.uploadQueue.keepBoth": "保留两者",
  "files.uploadQueue.retry": "重试",
  ...
  "git.dlgEarlier": "更早",
  "git.loadMore": "加载更早提交",
  "git.commitFiles": "变更文件 · {{n}}",
  "git.commitFileCap": "点文件 → 单文件 diff（对比基准 = 本次提交）",
  "git.branchesTitle": "分支 · {{n}}",
  "git.sectCurrentBranch": "当前分支",
  "git.sectOtherBranches": "其他分支 · {{n}}",
  "git.sectRemoteBranches": "远程分支",
  "git.merged": "已合并",
  "git.branchAheadBehindSub":
    "领先 {{base}} {{ahead}} 个提交 · 落后 {{behind}} · 最近提交 {{time}}",
  "git.bcurSub": "最近提交 {{time}} · 检视与历史均基于此",
  "git.rocardTitle": "只读边界",
  "git.rocardDesc": "切换 / 合并 / 推送是写操作：交给 Agent 或终端执行，检视不做任何变更。",
  "git.diffBaseScope": "{{base}} ← {{scope}}",
  "git.scopeWorktree": "工作区",
  "git.scopeStaged": "暂存区",
  "git.nextChange": "下一个改动",
  ...
  "api.projectFileSearchFailed": "文件搜索失败",
  ...
  "api.wikiSearchFailed": "Wiki 索引获取失败",
  "api.projectSessionMessageFailed": "消息注入失败",
  ...
  "api.chatSessionPinFailed": "对话置顶失败",
  "api.chatSessionUnpinFailed": "对话取消置顶失败",
  "api.chatSessionArchiveFailed": "对话归档失败",
  "api.chatSessionUnarchiveFailed": "对话恢复失败",
  ...
  "claude.retry.countTitle": "API 错误 · {{error}}",
  "claude.autoRetryPending.title": "发送失败 · 自动重试已排程",
  "claude.autoRetryPending.retryNow": "立即重试",
  "claude.retry.countSchedule": "{{time}} 后自动重发 · 第 {{attempt}}/{{max}} 次",
  ...
  "workbench.scopeSegmentProject": "项目",
  "workbench.scopeSegmentAll": "全部",
  "workbench.statusBarAria": "状态栏",
  "workbench.statusConnected": "已连接",
  ...
  "workbench.projectTools": "项目工具",
  "workbench.emptyTitle": "这个项目还没有会话",
  "workbench.emptyDesc": "Agent 与终端实例会出现在这里",
  "workbench.emptyCta": "＋ 新建 Agent",
  "workbench.emptyBrowse": "先看看文件 / Git",
  ...
  "wiki.searchNoMatch": "没有匹配的页面",
  "wiki.groupUngrouped": "未分组",
  "wiki.pagesCount": "{{n}} 页",
  "wiki.readByAgent": "让 Agent 读这篇",
  "wiki.copyLink": "复制链接",
  "wiki.readOnlyCap": "—— 正文只读 · 编辑在源文件 ——",
  "wiki.updatedMeta": "更新 {{date}}",
  "wiki.refCardTitle": "Wiki 引用",
  "wiki.refCardRemove": "移除",
  "wiki.refnote": "已注入 {{n}} 个会话",
  "wiki.injectPrompt": "请阅读以下 wiki 页面并纳入上下文：\n\n【wiki:{{slug}}】{{title}}\n\n",
  "wiki.injectFailed": "注入失败",
  ...
  "workbench.switchSearch": "搜索项目或会话",
  "workbench.switchEmptyGroup": "暂无活跃会话 · 点分组头进入项目",
  "workbench.switchNewProject": "新建 / 采用项目",
  "workbench.menuHistory": "会话历史",
  "workbench.historyTitle": "会话历史",
  "workbench.historyFilterAll": "全部",
  "workbench.historyFilterRunning": "进行中",
  "workbench.historyFilterClosed": "已结束",
  "workbench.historyRunning": "运行中 · {{time}}",
  ...
  "approvals.nPending": "{{count}} 待审批",
  "approvals.allowAll": "全部允许 ›",
  "approvals.confirmAll": "确认允许 {{count}} 项？",
  "approvals.foot": "处理完自动通知对应会话继续 · 点卡片跳到会话位置 · 全部允许需确认",
  "approvals.empty": "暂无待审批",
  "api.approvalsFailed": "审批中心加载失败",
  "api.approvalsRespondFailed": "审批应答失败",
  "workbench.createTitle": "新建实例",
  "workbench.createGroupAgent": "AGENT 会话",
  "workbench.createGroupTerminal": "TERMINAL",
  "workbench.createClaudeDesc": "默认模型预设",
  "workbench.createOmpDesc": "新运行时 · beta",
  "workbench.createTerminalFull": "终端（tmux）",
  "workbench.createTerminalDesc": "断线内容不丢",
  "workbench.pillCloseSession": "关闭会话…",
  ...
  "settings.acpConfiguredCount": "已配置 {{n}} 个",
  "settings.acpNotConfigured": "未配置",
  "settings.saving": "保存中…",
  "settings.saved": "已保存",
  ...
  // v2 07 设置页（五组：通用 / RUNTIME 预设 / 自动重试默认 / 服务器 / 退出登录）
  "settings.lang": "语言",
  "settings.langHint": "覆盖系统语言偏好；跟随系统 = 使用设备语言。",
  "settings.langZh": "中文",
  "settings.langEn": "English",
  "settings.runtimePresets": "RUNTIME 预设（新建实例时可选）",
  "settings.claudePreset": "Claude 模型预设",
  "settings.keySet": "已设置",
  "settings.keyUnset": "未设置",
  "settings.autoRetryDefaults": "自动重试默认（会话 ℹ 可覆盖）",
  "settings.retryMaxLabel": "次数上限",
  "settings.retryMaxValue": "{{n}} 次",
  "settings.retryDelay": "重试间隔",
  "settings.retryDelayValue": "{{s}} 秒（{{m}} 分钟滚动窗口）",
  "settings.retryMessage": "重发文案",
  "settings.section.server": "服务器",
  "settings.pwa": "PWA",
  "settings.pwaInstalled": "已安装",
  "settings.pwaBrowser": "浏览器中运行",
  "settings.logout": "退出登录…",
  "settings.logoutConfirm":
    "清除本设备的登录凭证。服务端数据与 Agent 会话不受影响，重新登录即可恢复访问。",

  // Plugins（插件入口：skill + mcp 两层作用域，导航重命名为 /plugins）
  "plugins.title": "插件",
  "plugins.switchProject": "切换项目",
  "plugins.skillTab": "技能",
  "plugins.mcpTab": "MCP",
  // v2 09 插件 Tab（作用域分段 + 搜索 + MCP/技能组 + 市场段；§3.5）
  "plugins.scopeGlobal": "全局",
  "plugins.scopeProject": "本项目 · {{name}}",
  "plugins.scopeProjectEmpty": "本项目",
  "plugins.scopeAria": "插件作用域",
  "plugins.pickProject": "去工作台选择项目",
  "plugins.pickProjectHint": "选择一个项目后，可管理注入该项目 Agent 会话的技能与 MCP 服务器",
  "plugins.searchPlaceholder": "搜索技能与 MCP",
  "plugins.mcpGroup": "MCP 服务器 · {{n}}",
  "plugins.skillsGroup": "已安装技能 · {{n}}",
  "plugins.market": "市场",
  "plugins.manageSources": "管理源 ›",
  "plugins.skillMarket": "技能市场",
  "plugins.mcpMarket": "MCP 市场",
  "plugins.mcpMarketTitle": "MCP 市场",
  "plugins.marketTabMcp": "MCP 服务器",
  "plugins.marketTabSkill": "技能",
  "plugins.mcpSearchPlaceholder": "搜索 MCP 服务器",
  "plugins.officialRegistry": "✓ 官方 Registry",
  "plugins.mcpManualConfigNote": "该条目不支持一键安装，请在 MCP 服务器组手动添加",
  "plugins.marketTitle": "技能市场",
  "plugins.sourcesTitle": "市场源管理",
  "plugins.sourcesHint": "源 = 技能市场的目录地址；技能经源安装与更新",
  "plugins.officialCurated": "官方精选",
  "plugins.builtinTag": "内置",
  "plugins.officialTag": "✓ 官方",
  "plugins.curatedDesc": "人工策展 · 随版本发布 · 离线可用",
  "plugins.skillsShDesc": "skills.sh 技能目录",
  "plugins.customSourceTag": "自定义",
  "plugins.addCustomSource": "＋ 添加自定义源",
  "plugins.emptyMarket": "输入至少 2 个字符搜索技能",
  "plugins.emptyMcp": "暂无 MCP 服务器，点右上 ＋ 添加",
  "plugins.emptySkills": "暂无已安装技能，去市场安装",
  "plugins.marketFoot": "来源与类型绑定：技能市场不含 MCP 源，反之亦然",
  "plugins.scopeField": "作用域",
  "skills.installedChip": "已安装",
  ...
  "mcp.detailConfig": "配置",
  "mcp.detailScope": "注入范围",
  "mcp.scopeGlobalValue": "全局 · 所有 Agent 会话",
  "mcp.scopeProjectValue": "本项目 · {{name}}",
  "mcp.marketEnvField": "环境变量 {{name}}",
  "mcp.marketHeaderField": "请求头 {{name}}",
  "mcp.envMasked": "••••••（脱敏）",
  "mcp.removeNote": "移除后使用该服务器的会话将失去对应工具，新会话不再加载",
  "mcp.addSheetNote": "MCP 服务器可访问本机资源并执行命令；添加后新会话生效",
  ...
  "chat.restore": "恢复",
  "chat.pinnedGroup": "置顶",
  "chat.archivedGroup": "已归档 ({{count}})",
  "chat.emptyArchived": "暂无已归档对话。",
  "chat.clearArchived": "清空",
  "chat.clearArchivedConfirmTitle": "清空已归档对话？",
  "chat.clearArchivedConfirmMessage": "将永久删除 {{count}} 个已归档对话，且不可恢复。",
  "chat.pinnedAria": "已置顶对话",
  "chat.archivedAria": "已归档对话",
  "chat.selectedCount": "已选 {{count}} 项",
  "chat.selectAll": "全选",
  "chat.archiveSelected": "归档",
  "chat.deleteSelected": "删除",
  "chat.cancelSelect": "取消",
  "pi.attach": "添加图片",
  "pi.attachAria": "添加图片",
