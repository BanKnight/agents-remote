export const en = {
  ...
  "home.modeCreate": "New folder",
  "home.modeAdopt": "Adopt existing",
  "home.adoptLoading": "Scanning PROJECTS_ROOT…",
  "home.adoptEmpty": "No folders to adopt (all managed)",
  "home.adopting": "Adopting…",
  "home.adoptAction": "Adopt {{count}} folder(s)",
  "home.searchPlaceholder": "Search projects and sessions",
  "home.globalActivity": "Global activity",
  "home.nRunning": "{{count}} running",
  "home.seeAllActivity": "See all activity",
  "home.collapseActivity": "Collapse activity",
  "home.projectsTitle": "Projects · {{count}}",
  "home.instanceRecent": "{{count}} instances · recent: {{name}} ({{time}})",
  "home.idle": "Idle",
  "home.noActivity": "No active sessions",
  ...
  "session.autoRetry.maxLabel": "Max per window",
  "session.autoRetry.windowLabel": "Window (min)",
  ...
  "files.moving": "Moving…",
  "files.move": "Move",
  "files.menuCreateHere": "New folder here",
  ...
  "files.deleteDirtyWarn": "This file has uncommitted changes in the working tree.",
  "files.capBreadcrumb":
  ...
  "git.dlgToday": "Today",
  "git.dlgYesterday": "Yesterday",
  "git.dlgThisWeek": "This week",
  "git.dlgEarlier": "Earlier",
  "git.loadMore": "Load earlier commits",
  "git.commitFiles": "Changed files · {{n}}",
  "git.commitFileCap": "Tap a file → per-file diff (against this commit)",
  "git.branchesTitle": "Branches · {{n}}",
  "git.sectCurrentBranch": "Current branch",
  "git.sectOtherBranches": "Other branches · {{n}}",
  "git.sectRemoteBranches": "Remote branches",
  "git.merged": "Merged",
  "git.branchAheadBehindSub":
    "{{ahead}} ahead of {{base}} · {{behind}} behind · last commit {{time}}",
  ...
  "api.projectFileSearchFailed": "File search failed",
  ...
  "api.wikiSearchFailed": "Wiki index load failed",
  "api.projectSessionMessageFailed": "Session message injection failed",
  ...
  "api.chatSessionPinFailed": "Failed to pin chat session",
  "api.chatSessionUnpinFailed": "Failed to unpin chat session",
  "api.chatSessionArchiveFailed": "Failed to archive chat session",
  "api.chatSessionUnarchiveFailed": "Failed to restore chat session",
  ...
  "claude.retry.countTitle": "API error · {{error}}",
  "claude.autoRetryPending.title": "Send failed · auto-retry scheduled",
  "claude.autoRetryPending.retryNow": "Retry now",
  "claude.retry.countSchedule": "Auto-resend in {{time}} · attempt {{attempt}}/{{max}}",
  "claude.offlineCap": "—— Offline · new content will backfill after reconnect ——",
  ...
  "workbench.scopeSegmentProject": "Project",
  "workbench.scopeSegmentAll": "All",
  "workbench.statusBarAria": "Status bar",
  "workbench.statusConnected": "Connected",
  ...
  "workbench.projectTools": "Project tools",
  "workbench.emptyTitle": "No sessions in this project yet",
  "workbench.emptyDesc": "Agent and terminal instances will appear here",
  "workbench.emptyCta": "+ New Agent",
  "workbench.emptyBrowse": "Browse files / Git",
  ...
  "wiki.searchNoMatch": "No matching pages",
  "wiki.groupUngrouped": "Ungrouped",
  "wiki.pagesCount": "{{n}} pages",
  "wiki.readByAgent": "Have an agent read this",
  "wiki.copyLink": "Copy link",
  "wiki.readOnlyCap": "—— Read-only · edit in source files ——",
  "wiki.updatedMeta": "Updated {{date}}",
  "wiki.refCardTitle": "Wiki reference",
  "wiki.refCardRemove": "Remove",
  "wiki.refnote": "Injected into {{n}} sessions",
  "wiki.injectPrompt":
    "Please read the following wiki page and keep it in context:\n\n【wiki:{{slug}}】{{title}}\n\n",
  "wiki.noSessions": "No agent sessions to inject",
  ...
  "workbench.switchSearch": "Search projects or sessions",
  "workbench.switchEmptyGroup": "No active sessions · tap a group header to open the project",
  "workbench.switchNewProject": "New / adopt project",
  "workbench.menuHistory": "Session history",
  "workbench.historyTitle": "Session history",
  "workbench.historyFilterAll": "All",
  "workbench.historyFilterRunning": "In progress",
  "workbench.historyFilterClosed": "Ended",
  "workbench.historyRunning": "Running · {{time}}",
  ...
  "approvals.nPending": "{{count}} pending",
  "approvals.allowAll": "Allow all ›",
  "approvals.confirmAll": "Allow all {{count}}?",
  "approvals.foot":
    "Sessions auto-resume after decisions · Tap a card to jump to the session · Allow all asks once",
  "approvals.empty": "Nothing pending",
  "api.approvalsFailed": "Failed to load approvals",
  "api.approvalsRespondFailed": "Failed to respond to approval",
  "workbench.createTitle": "New instance",
  "workbench.createGroupAgent": "AGENT SESSIONS",
  "workbench.createGroupTerminal": "TERMINAL",
  "workbench.createClaudeDesc": "Default model preset",
  "workbench.createOmpDesc": "New runtime · beta",
  "workbench.createTerminalFull": "Terminal (tmux)",
  "workbench.createTerminalDesc": "Session survives disconnect",
  "workbench.pillCloseSession": "Close session…",
  ...
  "chat.select": "Select chats",
  "chat.pin": "Pin",
  "chat.unpin": "Unpin",
  "chat.archive": "Archive",
  "chat.restore": "Restore",
  "chat.pinnedGroup": "Pinned",
  "chat.archivedGroup": "Archived ({{count}})",
  "chat.emptyArchived": "No archived chats.",
  "chat.clearArchived": "Clear all",
  "chat.clearArchivedConfirmTitle": "Clear archived chats?",
  "chat.clearArchivedConfirmMessage":
    "{{count}} archived chat(s) will be permanently deleted and cannot be recovered.",
  "chat.pinnedAria": "Pinned chats",
  "chat.archivedAria": "Archived chats",
  "chat.selectedCount": "{{count}} selected",
  "chat.selectAll": "Select all",
  "chat.archiveSelected": "Archive",
