...
function UserChatBubble() {
  ...
  return (
    <MessagePrimitive.Root className="flex justify-end pl-3 pr-3 py-1.5 sm:pl-5 sm:pr-5 group relative [content-visibility:auto] [contain-intrinsic-size:auto_200px]">
...
function AssistantChatBubble() {
  ...
  return (
    <MessagePrimitive.Root className="flex justify-start px-3 py-1.5 sm:px-5 group relative [content-visibility:auto] [contain-intrinsic-size:auto_200px]">
...
function SystemChatBubble() {
  ...
  if (systemMessageType === "tool-card") {
    ...
    return (
      <MessagePrimitive.Root
        className={`flex justify-start px-3 sm:px-5 group relative ${rootPy[groupPos] ?? rootPy.solo} [content-visibility:auto] [contain-intrinsic-size:auto_200px]`}
      >
        {indent ? (
  ...
  if (systemMessageType === "batch-boundary") {
    return (
      <MessagePrimitive.Root className="flex w-full px-3 sm:px-5 py-1.5 [content-visibility:auto] [contain-intrinsic-size:auto_48px]">
  ...
  if (systemMessageType === "compact-boundary") {
    ...
    return (
      <MessagePrimitive.Root className="flex w-full items-center gap-2 px-3 sm:px-5 py-1.5 [content-visibility:auto] [contain-intrinsic-size:auto_48px]">
  ...
  const fileSnapshot =
    rawData && (rawData as { type?: string }).type === "file-history-snapshot"
      ...
      : null;
  return (
    <MessagePrimitive.Root className="flex justify-start px-3 py-1.5 sm:px-5 group [content-visibility:auto] [contain-intrinsic-size:auto_200px]">
