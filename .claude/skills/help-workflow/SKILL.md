...
- `.workflow/roadmap.md`：当前活跃 versions / changes 的索引和当前焦点。
- `.workflow/changes/<change-id>/progress.md`：单个 change 的阶段状态、局部阻塞和进展记录；阶段到技能的路由由 `step-change` 决定。
